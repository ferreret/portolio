      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mb-10 flex flex-wrap gap-2">
          <button
            ...
            className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 border ${selectedTag === null
          ...
          {allTags.map(tag => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 border ${selectedTag === tag
                ? 'bg-primary-600 border-primary-600 text-white shadow-md'
                : 'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:border-primary-400 dark:hover:border-primary-500'
                }`}
            >
                ...
                <div className="flex flex-wrap gap-2 mt-auto">
                  {project.tags.map(tag => (
                    <button
                      ...
                      className={`text-xs font-semibold px-2.5 py-1 rounded-md transition-colors border ${selectedTag === tag
